...
public class FeedbackPopUp extends Dialog implements View.OnClickListener {
    private ViewGroup transitionsContainer;
    private LinearLayout btnCheck, btnConfirm, layoutCancel;
...
//            throw new IllegalStateException("setCustomView - You cannot use it when you want progress CustomDialog");
//        }
//
...
//    }
    ...
    @UiThread
    private void setLayout(final FeedbackPopUp dialog) {
        final FeedbackPopUp.Builder builder = dialog.builder;

//        if (builder.showProgress) {
        setContentView(R.layout.feedback_popup);
        transitionsContainer = (ViewGroup) findViewById(R.id.layout_dialog);
        btnCancel = (AppCompatTextView) transitionsContainer.findViewById(R.id.txtSubmit);
...
//        }
        ...
        if (builder.isCancelableOnTouchOutside) {
            RelativeLayout layoutOutside = (RelativeLayout) findViewById(R.id.layout_container);
    ...
    protected FeedbackPopUp(Builder builder) {
        ...
        switch (tag) {
            case CONFIRM:
                ...
                if (builder.onConfirmCallback != null) {
                    ...
                    if (isPermanentSet()) {
                        Log.e("CustomDialog", "Use BtnCallbackWithPermanentCheck instead of BtnCallback " +
    ...
    public interface BtnCallback {
        void onClick(@NonNull FeedbackPopUp dialog, @NonNull BtnAction which);
    }

    public interface BtnCallbackWithPermanentCheck {
        void onClick(@NonNull FeedbackPopUp dialog, @NonNull BtnAction which, boolean isPermanentChecked);
    }
    ...
    public static class Builder {
        ...
        public Builder setTitle(@NonNull String message, boolean isBold) {
            if (this.showProgress) {
                throw new IllegalStateException("setTitle - You cannot use it when you want progress CustomDialog");
            }
        ...
        @UiThread
        public FeedbackPopUp build() {
            return new FeedbackPopUp(this);
        }

        @UiThread
        public FeedbackPopUp show() {
            if (this.preferenceName != null && this.permanentCheckKey != null) {
                Log.e("CustomDialog", "Use showIfPermanentValueIsFalse() instead of show() for efficiency");
            }
        ...
        @UiThread
        public FeedbackPopUp showIfPermanentValueIsFalse() {
        ...
        @UiThread
        private FeedbackPopUp showDialog() {
            FeedbackPopUp dialog = build();
            dialog.show();
            return dialog;
        }
