package com.thealer.telehealer.common.OpenTok.Renders;
...
public class BasicCustomVideoRenderer extends BaseVideoRenderer{
    ...
    @Nullable
    public ScreenCapturerInterface screenCapturerInterface;
    ...
    static class MyRenderer implements GLSurfaceView.Renderer {
        ...
        public void displayFrame(Frame frame) {
            ...
            if(mCustomVideoRenderer.mSaveScreenshot) {
                ...
                Log.d("VideoRender","bit map created");
                mCustomVideoRenderer.mSaveScreenshot = false;

                if (mCustomVideoRenderer.screenCapturerInterface != null) {
                    mCustomVideoRenderer.screenCapturerInterface.didCapturerScreenShot(bmp);
                }
    ...
    public void saveScreenshot(Boolean enableScreenshot, ScreenCapturerInterface screenCapturerInterface){
        mSaveScreenshot = enableScreenshot;
        this.screenCapturerInterface = screenCapturerInterface;
    }
