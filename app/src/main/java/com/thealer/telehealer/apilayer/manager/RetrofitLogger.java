...
public class RetrofitLogger implements Interceptor {
    ...
    public RetrofitLogger(HttpLoggingInterceptor.Logger logger) {
        this.logger = logger;
    }
    ...
    public RetrofitLogger setLevel(HttpLoggingInterceptor.Level level) {
    ...
    @Override public Response intercept(Chain chain) throws IOException {
        ...
        EventRecorder.recordAPIEvent(request.url().url().getPath(),request.method(),response.code());
