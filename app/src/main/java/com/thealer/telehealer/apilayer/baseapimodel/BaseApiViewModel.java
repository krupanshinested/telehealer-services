    ...
    private void handleUnAuth(ErrorModel errorModel) {
        ...
        if (!isQuickLoginReceiverEnabled) {
            ...
            if (errorModel.getMessage().equals(getApplication().getString(R.string.token_expired)) ||errorModel.getMessage().equals(getApplication().getString(R.string.str_refresh_token_expired)) ||
                    ...
                    errorModel.getMessage().equals(getApplication().getString(R.string.invalid_token)))
                goToSigninActivity();
        }
    }
        ...
        if (e instanceof NoConnectivityException || e instanceof SocketTimeoutException) {
            ...
            try {
                ...
                if (e1 instanceof HttpException)
                    ...
                    errorModelLiveData.setValue(new ErrorModel(((HttpException) e).code() == 404 ? ((HttpException) e).code()  : -1, getApplication().getString(R.string.something_went_wrong_try_again), getApplication().getString(R.string.something_went_wrong_try_again)));
            }
