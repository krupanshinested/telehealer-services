 ...
 */
public class NewDocumentListAdapter extends RecyclerView.Adapter<NewDocumentListAdapter.ViewHolder> {
    ...
    public NewDocumentListAdapter(FragmentActivity activity, boolean isFromHome, int spanCount) {
