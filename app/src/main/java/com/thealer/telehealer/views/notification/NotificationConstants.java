...
public class NotificationConstants {
    ...
    public static List<String> getNotificationDisplayFilters(Context context){
        List<String> filterOptions = new ArrayList<>(Arrays.asList(context.getString(R.string.schedules),
                ...
                context.getString(R.string.orders), context.getString(R.string.forms), context.getString(R.string.calls), context.getString(R.string.educational_video)));
    ...
    public static List<String> getNotificationFilterTypes(Context context){
        List<String> filterOptions = new ArrayList<>(Arrays.asList(APPOINTMENT, CONNECTIONS, VITALS, MESSAGES, ORDERS, FORMS, CALLS,EDUCATIONAL_VIDEO));
        if (!UserType.isUserPatient()){
